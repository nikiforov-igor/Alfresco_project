...
public class JRXMLProducer {
    ...
    // TODO: доработать прототип для автонормировки ширины колонок
     ...
     */
    public static ByteArrayOutputStream updateJRXML(InputStream jrxml, String streamName, ReportDescriptor desc) {
        if (jrxml == null) {
            return null;
        }
        if (desc == null) {
