...
public class RosterItem {
	...
	public RosterItem(String jid, String name, Subscription subscription, boolean ask, String[] groups) {
		super();
		this.jid = jid;
		this.name = name;
	...
	public RosterItem(String jid, String name, Subscription subscription, boolean ask, String[] groups, String order) {
		super();
		this.jid = jid;
		this.name = name;
		this.subscription = subscription;
