...
public class ReportDAOImpl implements ReportEditorDAO {
    ...
    public ReportTemplate getReportTemplate(String rtMnemo) {
        ...
        return createReportTemplate(rs.getNodeRef(0));
    }
    ...
    private JavaDataType createColDataType(NodeRef nodeColType) {
        ...
        final String name = getString(map, ContentModel.PROP_NAME.toPrefixString(getServices().getServiceRegistry().getNamespaceService()));
    ...
    public NodeRef getReportDescriptorNodeByCode(String rtMnemo) {
        LuceneSearchBuilder builder = new LuceneSearchBuilder(getServices().getServiceRegistry().getNamespaceService());
