...
//								div.className = "lecm-dt-liner";
					...
					},
					{
						...
						formatter: function(el, oRecord, oColumn, oData) {
							...
							var docTypeIconSpan = '<span class="document-type ' + (oRecord._oData.docType || '').replace(':', '_') + '"> </span>';
							...
							var descrBlock = '<div class="item-description">' + directionIconSpan + docTypeIconSpan + linkBlock + '</div>';
