...
//	private SplitButton uploadButton;
	...
	private void createButtonPanel(JPanel panel) {
		...
		uploadButton = new JButton(ScannerApplet.getMessage("label.action.pdf"));
...
//		uploadButton.addMenuItem(new JMenuItem(getUploadTiffAction()));
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if ("progress".equals(evt.getPropertyName())) {
			...
			if (!task.isCancelled() && task.getThrowable() == null) {
				if (task instanceof UploadTask) {
					JOptionPane.showMessageDialog(getFrame(),
									ScannerApplet.getMessage("label.dialog.completed.upload"),
									ScannerApplet.getMessage("label.dialog.upload"),
									JOptionPane.INFORMATION_MESSAGE);
				}	else if (task instanceof SaveTask) {
					JOptionPane.showMessageDialog(getFrame(),
									ScannerApplet.getMessage("label.dialog.completed.save"),
									ScannerApplet.getMessage("label.dialog.save"),
									JOptionPane.INFORMATION_MESSAGE);
				}				
			}*/
		}
