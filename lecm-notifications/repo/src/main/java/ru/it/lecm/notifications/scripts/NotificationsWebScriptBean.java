...
//		подёргаем перед выполнением.
	...
	public boolean isTemplateEnabledForCurrentEmployee(String templateCode) {
		return service.isTemplateNotificationsEnabled(templateCode, orgstructureService.getCurrentEmployee());
	}
}
