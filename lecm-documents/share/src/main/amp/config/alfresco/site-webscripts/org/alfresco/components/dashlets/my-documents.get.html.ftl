<!-- My Documents -->
<@link rel="stylesheet" type="text/css" href="${url.context}/res/components/dashlets/my-documents.css" />
<@script type="text/javascript" src="${url.context}/res/components/dashlets/my-documents.js"></@script>
<@script type="text/javascript" src="${url.context}/res/scripts/dashlets/lecm-my-documents.js"></@script>
...
(function()
{
   new LogicECM.dashlet.MyDocuments("${jsid}").setOptions(
   {
