...
LogicECM.TaskDistribution = LogicECM.TaskDistribution || {};

(function () {

	LogicECM.TaskDistribution.Toolbar = function (containerId) {
		LogicECM.TaskDistribution.Toolbar.superclass.constructor.call(this, "LogicECM.TaskDistribution.Toolbar", containerId, ["button", "container", "connection", "json", "selector"]);
		YAHOO.Bubbling.on("selectedTasksChanged", this.onSelectedTasksChanged, this);
		this.selectedTasks = [];
		return this;
	};

	YAHOO.lang.extend(LogicECM.TaskDistribution.Toolbar, Alfresco.component.Base, {
