...
<div id="${id}-import-xml" class="import-xml" title="${msg('button.import-xml')}" style="float: right; padding-top: 7px;">
    ...
    <div id="${importInfoFormId}" class="yui-panel">
        ...
        <div id="${importInfoFormId}-body" class="bd">
            <div id="${importInfoFormId}-content" class="import-info-content" style="margin: 5px;"></div>
        </div>
    </div>
    ...
    <div id="${importErrorFormId}" class="yui-panel">
        ...
        <div id="${importErrorFormId}-body" class="bd">
            <div id="${importErrorFormId}-content" class="import-info-content" style="margin: 5px;">
    ...
    <div id="${importFormId}" class="yui-panel">
        ...
        <div id="${importFormId}-body" class="bd" style="margin: 5px;">
