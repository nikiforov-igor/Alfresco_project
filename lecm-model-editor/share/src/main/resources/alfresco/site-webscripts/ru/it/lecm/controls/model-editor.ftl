...
<@script type="text/javascript" src="${page.url.context}/res/components/model-editor/controls/dialog.js" />
<@script type="text/javascript" src="${page.url.context}/res/components/model-editor/controls/input.js" />
<@script type="text/javascript" src="${page.url.context}/res/components/model-editor/controls/select.js" />
<@script type="text/javascript" src="${page.url.context}/res/components/model-editor/model-editor.js" />
...
<#if form.mode != "view">
	...
	<div id="${fieldHtmlId}_base" class="models">
		...
		<div id="${fieldHtmlId}_props" style="display:none;">
