		...
		YAHOO.widget.DataTable,
		{
			...
			**/
			expandRow : function( record_id, restore ){
				...
				empty_cell.innerHTML = '<div class="graph-tree-empty-cell"></div>';
				empty_cell.setAttribute("style", "position: relative; vertical-align: top;");

				new_row.appendChild(empty_cell);
				var new_column = document.createElement( 'td' );
				new_column.colSpan = column_length-1;

				new_column.innerHTML = '<div class="'+ CLASS_LINER +'"></div>';
				new_row.appendChild( new_column );

				//var liner_element = new_row.firstChild.firstChild;
				var liner_element = new_column.firstChild;
