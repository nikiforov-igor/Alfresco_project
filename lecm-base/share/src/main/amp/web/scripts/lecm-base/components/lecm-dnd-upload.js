 ...
 *
 * var dndUpload = LogicECM.component.getDNDUploadInstance();
...
(function()
{
    ...
    * @return {LogicECM.component.DNDUpload} The new DNDUpload instance
    * @constructor
    * @private
    */
   LogicECM.DNDUpload = function(htmlId)
   {
	   LogicECM.DNDUpload.superclass.constructor.call(this, "LogicECM.DNDUpload", htmlId, ["button", "container", "datatable", "datasource"]);
   ...
   YAHOO.extend(LogicECM.DNDUpload, Alfresco.component.Base,
   {
      /**
              ...
              var successListener = function DNDUpload_successListener(e)
              {
               ...
               else
               {
                  ...
                  var uploadData =
                  {
	                 ...
	                 updateNodeRef: scope.showConfig.updateNodeRef
                  };
       ...
       */
      onUploadFile: function FlashUpload_onRowAddEvent(fileId)
      {
         try
         {
            ...
            if (this.uploadMethod === this.FORMDATA_UPLOAD)
            {
	           ...
	           if (this.showConfig.mode === this.MODE_SINGLE_UPDATE)
	           {
		           ...
		           formData.append("majorVersion", !this.minorVersion.checked);
	   ...
	   onUploadButtonClick: function DNDUpload_onUploadButtonClick() {
		   ...
		   this.majorVersion.disabled = true;
			...
			if (this.fileStore != null) {
				for (var fileId in this.fileStore) {
					this.onUploadFile(fileId);
				}
			}
	   },
...
LogicECM.getDNDUploadProgressInstance = function()
{
	var instanceId = "LogicECM.DNDUpload";
