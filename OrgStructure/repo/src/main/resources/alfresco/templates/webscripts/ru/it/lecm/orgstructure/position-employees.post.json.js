...
function getData() {
    ...
    if (unitNode != null) {
        ...
        var pos_assocs = unitNode.sourceAssocs["lecm-orgstr:composition-position-assoc"];
        for each (pos_assoc in pos_assocs) {
            var employees = pos_assoc.assocs["lecm-orgstr:composition-employee-assoc"];
