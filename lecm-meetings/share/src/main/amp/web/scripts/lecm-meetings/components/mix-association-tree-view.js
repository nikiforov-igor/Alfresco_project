...
(function()
{
	...
	YAHOO.extend(LogicECM.module.MixAssociationTreeViewer, Alfresco.component.Base,
	{
        tree: null,
		...
		options:
		{
            ...
            pickerItemsScript: "lecm/forms/picker/mix/items",
        ...
        onReady: function MixAssociationTreeViewer_onReady() {
        ...
        showCreateNewItemWindow: function MixAssociationTreeViewer_showCreateNewItemWindow() {
        ...
        _loadSearchProperties: function MixAssociationTreeViewer__loadSearchProperties() {
        ...
        _loadSelectedItems: function MixAssociationTreeViewer__loadSelectedItems(clearCurrentDisplayValue, updateForms)
        {
            var arrItems = "";
            ...
            var onSuccess = function MixAssociationTreeViewer__loadSelectedItems_onSuccess(response)
            {
            ...
            var onFailure = function MixAssociationTreeViewer__loadSelectedItems_onFailure(response)
            {
                this.selectedItems = {};
            };
                ...
                Alfresco.util.Ajax.jsonRequest(
                    {
                        ...
                        dataObj:
                        {
							...
							itemTypeSubstituteStrings: this.options.itemTypeSubstituteStrings
                        },
                        successCallback:
                        {
                            fn: onSuccess,
        ...
        addSelectedItem: function MixAssociationTreeViewer_addSelectedItems(nodeRef) {
            var onSuccess = function MixAssociationTreeViewer_addSelectedItems_onSuccess(response)
            {
                var items = response.json.data.items,
                    item;
            ...
            var onFailure = function MixAssociationTreeViewer_addSelectedItems_onFailure(response) {
        ...
        showTreePicker: function MixAssociationTreeViewer_showTreePicker(e, p_obj)
        {
            if( ! this.widgets.dialog )
                return;
        ...
        fillPickerDialog: function MixAssociationTreeViewer_fillPickerDialog()
        {
            if (!this.options.plane) {
        ...
        _loadRootNode: function MixAssociationTreeViewer__loadRootNode() {
        ...
        _generateRootUrlPath: function MixAssociationTreeViewer__generateItemsUrlPath(nodeRef)
        {
            return $combine(Alfresco.constants.PROXY_URI, "/lecm/forms/node/search", nodeRef.replace("://", "/"));
        },

        _generateRootUrlParams: function MixAssociationTreeViewer__generateItemsUrlParams()
        {
        ...
        _generateItemsUrlParams: function MixAssociationTreeViewer__generateItemsUrlParams()
        {
        ...
        treeViewClicked: function MixAssociationTreeViewer_treeViewClicked(node)
        {
        ...
        _createSelectedControls: function MixAssociationTreeViewer__createSelectedControls()
        {
            var me = this;
            ...
            this.widgets.dataSource.doBeforeParseData = function MixAssociationTreeViewer_doBeforeParseData(oRequest, oFullResponse)
            {
            ...
            var fnAddItemHandler = function MixAssociationTreeViewer__createControls_fnAddItemHandler(layer, args)
            {
            ...
            var fnCreateNewItemHandler = function MixAssociationTreeViewer__createControls_fnCreateNewItemHandler(layer, args)
            {
                if (this.doubleClickLock) return;
                this.doubleClickLock = true;
        ...
        generateCreateNewParams: function MixAssociationTreeViewer_generateCreateNewParams(nodeRef, itemType) {
            return {
                itemKind: "type",
                itemId: itemType,
                destination: nodeRef,
         ...
         */
        fnRenderItemName: function MixAssociationTreeViewer_fnRenderItemName()
        {
            var scope = this;

            return function MixAssociationTreeViewer_renderItemName(elCell, oRecord, oColumn, oData)
            {
                var template = '';
         ...
         */
        fnRenderCellAdd: function MixAssociationTreeViewer_fnRenderCellAdd()
        {
            var scope = this;

            return function MixAssociationTreeViewer_renderCellAdd(elCell, oRecord, oColumn, oData)
            {
        ...
        renderItem: function MixAssociationTreeViewer_renderItem(item, template)
        {
            var me = this;

            var renderHelper = function MixAssociationTreeViewer_renderItem_renderHelper(p_key, p_value, p_metadata)
            {
                return $html(p_value);
            };
        ...
        canItemBeSelected: function MixAssociationTreeViewer_canItemBeSelected(id)
        {
            if (!this.options.multipleSelectMode && this.singleSelectedItem !== null)
            {
                return false;
        ...
        onRefreshItemList: function MixAssociationTreeViewer_onRefreshItemList(layer, args)
        {
        ...
        _updateItems: function MixAssociationTreeViewer__updateItems(nodeRef, searchTerm)
        {
		...
		_loadItems: function(nodeRef, searchTerm, clearList) {
			...
			var successHandler = function MixAssociationTreeViewer__updateItems_successHandler(sRequest, oResponse, oPayload)
			{
			...
			var failureHandler = function MixAssociationTreeViewer__updateItems_failureHandler(sRequest, oResponse)
			{
        ...
        _generateChildrenUrlPath: function MixAssociationTreeViewer__generatePickerChildrenUrlPath(nodeRef)
        {
            // generate the path portion of the url
            return $combine("/", nodeRef.replace("://", "/"), "children");
        },

        _generateChildrenUrlParams: function MixAssociationTreeViewer__generatePickerChildrenUrlParams(searchTerm)
        {
        ...
        removeNode: function MixAssociationTreeViewer_removeNode(event, params)
        {
        ...
        updateSelectedItems: function MixAssociationTreeViewer_updateSelectedItems() {
            ...
            for (i in items) {
	            if (typeof(items[i]) != "function") {
					...
					if (this.options.itemType == items[i].type) {
						if (items[i].type == "lecm-orgstr:employee") {
        ...
        getDefaultView: function (displayValue, item) {
	        ...
	        if (this.options.showAssocViewForm && item.nodeRef != null) {
		        result += "<a href='javascript:void(0);' " + " onclick=\"LogicECM.module.Base.Util.viewAttributes({nodeRef:\'" + item.nodeRef + "\', title: \'logicecm.view\' })\">" + displayValue + "</a>";
	        } else {
		        result += displayValue;
	        }
	        result += "</span>";
        ...
        updateAddButtons: function MixAssociationTreeViewer_updateAddButtons() {
            var button;
        ...
        getRemoveButtonHTML: function MixAssociationTreeViewer_getRemoveButtonHTML(node, dopId) {
	        if (!dopId) {
		        dopId = "";
	        }
        ...
        attachRemoveClickListener: function MixAssociationTreeViewer_attachRemoveClickListener(params) {
        ...
        updateFormFields: function MixAssociationTreeViewer_updateFormFields(clearCurrentDisplayValue) {
            // Just element
	        ...
	        if (el != null) {
	            ...
	            for (var i in this.selectedItems) {
		            ...
		            if(this.options.disabled) {
			            if (this.selectedItems[i].type == "lecm-orgstr:employee") {
        ...
        getAddedItems: function MixAssociationTreeViewer_getAddedItems()
        {
            var addedItems = [],
        ...
        getRemovedItems: function MixAssociationTreeViewer_getRemovedItems()
        {
            var removedItems = [],
                currentItems = Alfresco.util.arrayToObject(this.options.currentValue.split(","));
		...
		getSelectedItems:function MixAssociationTreeViewer_getSelectedItems() {
			var selectedItems = [];
		...
		getSelectedItemsNameSubstituteString:function MixAssociationTreeViewer_getSelectedItemsNameSubstituteString() {
        ...
        getEmployeesAbsenceInformation: function MixAssociationTreeViewer_getEmployeesAbsenceInformation(items) {
			var requestObj = [];
