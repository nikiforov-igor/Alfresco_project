...
//    }
//
//    public void addTimer(String stateMachineExecutionId, String timerDuration, String variable, List<TransitionExpression> expressions) throws WriteTransactionNeededException {
...
//        String stateMachineTaskId = stateMachineHelper.getCurrentTaskId(stateMachineExecutionId);
//
...
//    }
//
//    public void removeTimerNode(String stateMachineExecutionId) throws WriteTransactionNeededException {
//        String stateMachineTaskId = stateMachineHelper.getCurrentTaskId(stateMachineExecutionId);
...
//    }
//
//    private void nextTransition(final String stateMachineExecutionId, String stateMachineTaskId, String variable, List<TransitionExpression> expressions) throws WriteTransactionNeededException {
...
//            stateMachineHelper.stopDocumentSubWorkflows(statemachineId, null);
//        }
//
...
//    }
//
//    private void addTimerNode(String stateMachineExecutionId, String stateMachineTaskId, long finishTimestamp, String variable, List<TransitionExpression> expressions) throws WriteTransactionNeededException {
//        final NodeRef timerFolderRef = getTimerFolderRef();
//
...
//    }
//
//    private void restoreTimers() throws WriteTransactionNeededException {
//        List<NodeRef> timers = getTimers();
...
//    }
//
//    private List<NodeRef> getTimers() throws WriteTransactionNeededException {
...
//    }
//
//    private void createTimerFolderRef() throws WriteTransactionNeededException {
//        NodeRef timerFolderRef = getTimerFolderRef();
...
//    }
//
//    private NodeRef getTimerFolderRef() throws WriteTransactionNeededException {
...
//        stateMachineHelper.setExecutionParameters(stateMachineExecutionId, parameters);
//    }
//
