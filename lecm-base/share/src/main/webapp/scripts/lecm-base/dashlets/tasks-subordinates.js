...
(function()
{
    ...
    * @constructor
    */
   LogicECM.dashlet.TasksSubordinates = function (htmlId)
   {
	   LogicECM.dashlet.TasksSubordinates.superclass.constructor.call(this, "LogicECM.dashlet.TasksSubordinates", htmlId, ["button", "container", "datasource", "datatable", "paginator", "history", "animation"]);
    ...
    */
   YAHOO.extend(LogicECM.dashlet.TasksSubordinates, Alfresco.component.Base);

   /**
    * Augment prototype with Common Workflow actions to reuse createFilterURLParameters
    */
   YAHOO.lang.augmentProto(LogicECM.dashlet.TasksSubordinates, Alfresco.action.WorkflowActions);

   /**
    * Augment prototype with main class implementation, ensuring overwrite is enabled
    */
   YAHOO.lang.augmentObject(LogicECM.dashlet.TasksSubordinates.prototype,
   {
      /**
      ...
      onPreferencesLoaded: function (p_response)
      {
         ...
         var webscript = YAHOO.lang.substitute("lecm/base/api/task-subordinates-instances?authority={authority}&properties={properties}&exclude={exclude}",
         {
       ...
       */
      renderCellTaskInfo: function (elCell, oRecord, oColumn, oData)
      {
         var data = oRecord.getData(),
            desc = "";
         ...
         else
         {
	        ...
	        if (data.employee != null) {
		        employeeDesc = '<h3><a href="' + $siteURL('view-metadata?nodeRef=' + data.employee.nodeRef) + '" class="theme-color-1">' + data.employee.name + '</a></h3>';
	        }
            ...
            desc = employeeDesc + messageDesc + dateDesc + statusDesc + unassignedDesc;
         }
