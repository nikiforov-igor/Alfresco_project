...
<@link rel="stylesheet" type="text/css" href="${url.context}/res/css/lecm-errands/errands-menu.css"/>
<@script type="text/javascript" src="${url.context}/res/scripts/lecm-errands/errands-menu.js"></@script>
