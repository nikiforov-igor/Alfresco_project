...
<div id="${id}_metadata" class="metadata-form errands-main-form">
    <div id="${id}-form-fields" class="form-fields">
        ...
        <div class="clear"></div>
        <div class="main-info">
            ${msg("message.eddand.fromEmployee")} <a href="javascript:void(0);" onclick="LogicECM.module.Base.Util.viewAttributes('${props["lecm-errands:initiator-assoc-ref"]}', null, 'logicecm.employee.view')">${props["lecm-errands:initiator-assoc-text-content"]}</a>
            &nbsp;
            <span id="${id}-time-ago"></span>
            &nbsp;${msg("message.eddand.toEmployee")} <a href="javascript:void(0);" onclick="LogicECM.module.Base.Util.viewAttributes('${props["lecm-errands:executor-assoc-ref"]}', null, 'logicecm.employee.view')">${props["lecm-errands:executor-assoc-text-content"]}</a>
            <br/>
                ...
                <#if coexecs?? && coexecs?size gt 0>
                    <#list coexecs as coexec>
                        <li>
                            ...
                            <div class="person">
                                <div><a href="javascript:void(0);" onclick="LogicECM.module.Base.Util.viewAttributes('${coexec.employeeRef}', null, 'logicecm.employee.view')">${coexec.employeeName}</a></div>
                    ...
                    <#if childErrands?? && childErrands?size gt 0>
                        <#list childErrands as childErrand>
                            <li>
                                ...
                                <div class="person">
                                    <div>
                                        <a href="javascript:void(0);" onclick="LogicECM.module.Base.Util.viewAttributes('${childErrand.executorNodeRef}', null, 'logicecm.employee.view')">${childErrand.executorName}</a>
