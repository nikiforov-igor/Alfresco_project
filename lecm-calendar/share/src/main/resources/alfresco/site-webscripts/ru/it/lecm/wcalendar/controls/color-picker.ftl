...
var colorPickerInputField = new YAHOO.util.Element("${fieldHtmlId}");

colorPickerInputField.on("contentReady", function() {
	jscolor.init();
});
...
var jscolor = {
	...
	dir : '../res/images/lecm-calendar/jscolor/', // location of jscolor directory (leave empty to autodetect)
