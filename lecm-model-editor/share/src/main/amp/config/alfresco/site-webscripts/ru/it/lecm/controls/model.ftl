...
<div class="clear"></div>
<@script type='text/javascript' src='${url.context}/res/components/model-editor/controls/model.js' group='model-editor'/>
<@inlineScript group='model-editor'>
(function () {
	new LogicECM.module.ModelEditor.ModelControl('${fieldHtmlId}', {
