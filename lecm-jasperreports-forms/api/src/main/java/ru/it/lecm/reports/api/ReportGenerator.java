...
public interface ReportGenerator {
	...
	/**
	 * Вызывается менеджером при получении нового шаблона, чтобы провайдер 
	 * среагировал (например, успел построить .jasper для .jrxml)
	 * @param desc (!) зарегеный описатель
	 * @param templateData данные шаблона
	 * @param storage хранилище, определённое для отчёта (в котором данные templateData уже сохранены)
	 */
