...
<@link rel="stylesheet" type="text/css" href="${page.url.context}/css/lecm-dictionary/datagrid.css" />
...
<!-- Advanced Search -->
<@script type="text/javascript" src="${page.url.context}/res/ru/it/lecm/base-share/components/advsearch.js"></@script>
