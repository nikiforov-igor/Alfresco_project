var type = "lecm-document:base";
model.docType = type;
model.preferedFilter = "docAuthor";
...
/*    var settingsObj = eval("(" + settingsStr + ")");
    ...
    var PREFERENCE_ARM = template.properties.preferenceKey ? template.properties.preferenceKey + "." : "ru.it.lecm.arm.";
    model.preferenceKey = PREFERENCE_ARM;

    var prefStr = remote.connect("alfresco").get("/api/people/" + encodeURIComponent(user.id) + "/preferences?pf=" + PREFERENCE_ARM);
