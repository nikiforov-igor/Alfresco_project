...
<@link rel="stylesheet" type="text/css" href="${page.url.context}/res/ru/it/lecm/dictionary/datagrid2.css" />
<@link rel="stylesheet" type="text/css" href="${page.url.context}/res/components/data-lists/datagrid.css" />
<@script type="text/javascript" src="${page.url.context}/res/ru/it/lecm/dictionary/dictionary-datagrid.js"></@script>
