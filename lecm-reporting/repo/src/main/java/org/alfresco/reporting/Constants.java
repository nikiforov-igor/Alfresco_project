...
public class Constants {
   ...
   public static final String COLUMN_BJECT_TYPE = "object_type";
   ...
   public static final String REPORTING_PROPERTIES = "alfresco/module/org.alfresco.reporting/reporting-model.properties";
