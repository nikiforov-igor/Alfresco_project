 ...
 * $Date$
 */
package ru.it.lecm.im.client.xmpp.xmpp.privacy;
...
public class PrivacyListsPlugin implements Plugin {
	...
	public static interface RetrieveListsNamesHandler {
		void onRetrieve(String activeListName, String defaultListName, Set<String> listNames);
	}

	private final static Criteria CRIT = ElementCriteria.name("iq", new String[] { "type" }, new String[] { "set" }).add(
			ElementCriteria.name("query", new String[] { "xmlns" }, new String[] { "jabber:iq:privacy" }));
	...
	public void retrieveList(final String name, final RetrieveListHandler handler) {
