...
(function () {
    ...
    LogicECM.module.Documents.DataGrid = function (containerId) {
        return LogicECM.module.Documents.DataGrid.superclass.constructor.call(this, containerId);
    };

    YAHOO.lang.extend(LogicECM.module.Documents.DataGrid, LogicECM.module.Base.DataGrid);

    YAHOO.lang.augmentObject(LogicECM.module.Documents.DataGrid.prototype, {
