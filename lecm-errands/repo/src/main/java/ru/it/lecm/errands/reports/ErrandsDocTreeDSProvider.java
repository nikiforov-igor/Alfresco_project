 ...
 * @author rabdullin
 */
public class ErrandsDocTreeDSProvider extends GenericDSProviderBase {
    ...
    private static class ErrandsDocTreeParams {
        ...
        public String getLeveledAssocQn(int level) {
            ...
            return (this.levelsAssoc.containsKey(key))
    ...
    class SearchFilter {
        ...
        public AssocDataFilterImpl makeAssocFilter() {
            ...
            if (baseDoc != null) {
                result.addAssoc(new AssocDataFilter.AssocDesc(AssocDataFilter.AssocKind.target, ErrandsService.ASSOC_ADDITIONAL_ERRANDS_DOCUMENT, DocumentService.TYPE_BASE_DOCUMENT, baseDoc));
            }
