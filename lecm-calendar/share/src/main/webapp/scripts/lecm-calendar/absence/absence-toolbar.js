		...
		_createNewEmployeeAbsence: function Absence_newEmployeeAbsence(wantedBubblingLabel) {
			...
			return function(event, obj) {
				...
				employeeAbsenceForm.setOptions({
					...
					doBeforeFormSubmit: {
						fn: function() {
							var htmlNodeEnd = YAHOO.util.Dom.get(scope.id + "-createNewEmployeeAbsenceForm_prop_lecm-absence_end");
							var htmlNodeUnlimited = YAHOO.util.Dom.get(scope.id + "-createNewEmployeeAbsenceForm_prop_lecm-absence_unlimited");
							var endDate;
