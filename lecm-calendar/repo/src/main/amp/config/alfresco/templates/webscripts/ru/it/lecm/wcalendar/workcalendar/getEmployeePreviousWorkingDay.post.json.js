(function() {
	...
	var initialDateStr = request.initialDate;
	var initialDate = DateFromISO8601(initialDateStr);

	var offset = request.offset;

	var workingDate = workCalendar.getEmployeePreviousWorkingDay(nodeRefStr, initialDate, offset);

	if (workingDate === null) {
		workingDate = "never";
	}

	model.date = workingDate.toString();
}());
