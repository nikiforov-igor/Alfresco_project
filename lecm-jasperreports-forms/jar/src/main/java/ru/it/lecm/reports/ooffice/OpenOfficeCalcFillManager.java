...
import ru.it.lecm.reports.generators.OpenOfficeCalcTemplateGenerator;
 ...
 * @author snovikov
 */
public class OpenOfficeCalcFillManager {
    private static final transient Logger logger = LoggerFactory.getLogger(OpenOfficeCalcFillManager.class);

    final private OpenOfficeConnection connection;
    final private BasicDataSource basicDataSource;

    public OpenOfficeCalcFillManager(OpenOfficeConnection connection, BasicDataSource basicDataSource) {
     ...
     * @param urlSrc     исходный файл openOffice (".ods")
     * @param urlSaveAs  целевой файл (может иметь другой формат, например, ".xls")
     * @throws JRException
     */
    public void fill(ReportDescriptor report, Map<String, Object> parameters, JRDataSource dataSource, String urlSrc, String urlSaveAs) throws JRException {
        ...
        final OpenOfficeCalcTemplateGenerator ooGen = new OpenOfficeCalcTemplateGenerator(connection, basicDataSource);
