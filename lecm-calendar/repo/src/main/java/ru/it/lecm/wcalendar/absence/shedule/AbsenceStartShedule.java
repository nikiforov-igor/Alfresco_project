 ...
 *
 * @see ru.it.lecm.wcalendar.absence.shedule.AbsenceStartScheduleExecutor
 *
 * @author vlevin
 */
public class AbsenceStartShedule extends AbstractScheduledAction {
