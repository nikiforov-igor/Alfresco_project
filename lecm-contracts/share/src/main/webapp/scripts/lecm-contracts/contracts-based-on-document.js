(function () {
    ...
    LogicECM.module.Contracts.BasedOnDocumentSelection = function (htmlId) {
        var module = LogicECM.module.Contracts.BasedOnDocumentSelection.superclass.constructor.call(this, "LogicECM.module.Contracts.BasedOnDocumentSelection", htmlId, ["button", "container"]);
    ...
    YAHOO.lang.augmentObject(LogicECM.module.Contracts.BasedOnDocumentSelection.prototype,
        {
            ...
            onAfterSetItems: function onAfterSetItems_Function (layer, args) {
                var me = this;
