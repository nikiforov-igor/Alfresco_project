    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(staffManager.WSStaffManagerImplService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = staffManager.WSStaffManagerImplService.class.getResource(".");
