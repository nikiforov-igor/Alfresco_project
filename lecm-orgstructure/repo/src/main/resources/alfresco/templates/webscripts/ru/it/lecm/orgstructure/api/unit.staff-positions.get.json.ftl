...
[
	...
	<#if staff.assocs["lecm-orgstr:element-member-employee-assoc"]??>
        employee: "${staff.assocs["lecm-orgstr:element-member-employee-assoc"][0].getNodeRef()}",
        employeeName: "${staff.assocs["lecm-orgstr:element-member-employee-assoc"][0].getName()}",
	</#if>
