 ...
 * Time: 11:38
 */
public class ReassignTasks extends AbstractWebScript {
	final private static Logger logger = LoggerFactory.getLogger(ReassignTasks.class);
	...
	public void execute(WebScriptRequest req, WebScriptResponse res) throws IOException {
		...
		try {
			...
			String taskIds = (String) json.get("taskIds");
			if (ownerStr != null && taskIds != null) {
