 ...
 *         &lt;element name="ZAMEXECUTORS" type="{urn:DefaultNamespace}WSO_COLLECTION"/>
    ...
    extends WSOMTASK
{
    ...
    protected WSOCOLLECTION zamexecutors;
    ...
    /**
     * Gets the value of the zamexecutors property.
     * 
     * @return
     *     possible object is
     *     {@link WSOCOLLECTION }
    ...
    /**
     * Sets the value of the zamexecutors property.
     * 
     * @param value
     *     allowed object is
     *     {@link WSOCOLLECTION }
     *     
     */
    public void setZAMEXECUTORS(WSOCOLLECTION value) {
        this.zamexecutors = value;
    }
