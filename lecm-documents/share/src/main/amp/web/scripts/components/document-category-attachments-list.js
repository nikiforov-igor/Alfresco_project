...
/**
 * DocumentCategoryAttachmentsList
 *
 * @namespace LogicECM
 * @class LogicECM.DocumentCategoryAttachmentsList
 */
(function () {
    /**
     * YUI Library aliases
    ...
    var $html = Alfresco.util.encodeHTML,
        ...
        $date = function $date(date, format) {
    ...
    /**
     * DocumentCategoryAttachmentsList constructor.
     *
     * @param {String} htmlId The HTML id of the parent element
     * @return {LogicECM.DocumentCategoryAttachmentsList} The new DocumentCategoryAttachmentsList instance
     * @constructor
     */
    LogicECM.DocumentCategoryAttachmentsList = function DocumentCategoryAttachmentsList_constructor(htmlId) {
        LogicECM.DocumentCategoryAttachmentsList.superclass.constructor.call(this, "LogicECM.DocumentCategoryAttachmentsList", htmlId);
    ...
    YAHOO.extend(LogicECM.DocumentCategoryAttachmentsList, Alfresco.component.Base);

    /**
     * Augment prototype with Actions module
     */
    YAHOO.lang.augmentProto(LogicECM.DocumentCategoryAttachmentsList, Alfresco.doclib.Actions);
     ...
     */
    LogicECM.DocumentCategoryAttachmentsList.generateUserLink = function (scope, oUser) {
    ...
    LogicECM.DocumentCategoryAttachmentsList.generateLECMUserLink = function (scope, oUser, oUserRef) {
        if (oUserRef != null) {
     ...
     * </pre>
     */
    LogicECM.DocumentCategoryAttachmentsList.generateFileFolderLinkMarkup = function (scope, record) {
     ...
     */
    LogicECM.DocumentCategoryAttachmentsList.generateThumbnailUrl = function (record) {
    ...
    YAHOO.lang.augmentObject(LogicECM.DocumentCategoryAttachmentsList.prototype,
        {
            /**
             ...
             * @method onReady
             */
            onReady: function DocumentCategoryAttachmentsList_onReady() {
                var me = this;
...
//		            });
                    ...
                    if (owner !== null) {
                        if (typeof me[owner.title] === "function") {
                            ...
                            try {
                                ...
                                Alfresco.logger.error("DocumentCategoryAttachmentsList_fnActionHandler", owner.title, e);
                            }
                        }
                    }
                    return true;
            ...
            onFileUpload: function DocumentCategoryAttachmentsList_onFileUpload(e, obj) {
             ...
             */
            registerRenderer: function DocumentCategoryAttachmentsList_registerRenderer(propertyName, renderer) {
             ...
             */
            _setupMetadataRenderers: function DocumentCategoryAttachmentsList__setupMetadataRenderers() {
                /**
                 * Date
                 */
                this.registerRenderer("date", function (record, label) {
                    ...
                    var userLink = modifier ?
                        LogicECM.DocumentCategoryAttachmentsList.generateLECMUserLink(this, modifier, modifierRef) :
                        LogicECM.DocumentCategoryAttachmentsList.generateUserLink(this, properties.modifier);
             ...
             */
            _updateDocList: function DocumentCategoryAttachmentsList__updateDocList() {
            ...
            _buildDocListParams: function DocumentCategoryAttachmentsList__buildDocListParams() {
                // Build the URI stem
             ...
             * @protected
             */
            _setupDataSource: function DocumentCategoryAttachmentsList__setupDataSource() {
                var me = this;
             ...
             * @protected
             */
            _setupDataTable: function DocumentCategoryAttachmentsList__setupDataTable() {
                var me = this;
             ...
             */
            onEventHighlightRow: function DocumentCategoryAttachmentsList_onEventHighlightRow(oArgs) {
             ...
             * @param oArgs.record {YAHOO.widget.Record} The highlighted Record.
             */
            onEventUnhighlightRow: function DocumentCategoryAttachmentsList_onEventUnhighlightRow(oArgs) {
             ...
             */
            fnRenderCellSelected: function DocumentCategoryAttachmentsList_fnRenderCellSelected() {
                var scope = this;
             ...
             */
            fnRenderCellThumbnail: function DocumentCategoryAttachmentsList_fnRenderCellThumbnail() {
                var scope = this;
                 ...
                 * @param oData {object|string}
                 */
                return function DocumentCategoryAttachmentsList_renderCellThumbnail(elCell, oRecord, oColumn, oData) {
                    ...
                    if (scope.options.showFileFolderLink) {
                        elCell.innerHTML = '<span class="thumbnail">' + (isLink ? '<span class="link"></span>' : '') + LogicECM.DocumentCategoryAttachmentsList.generateFileFolderLinkMarkup(scope, record) + '<img id="' + imgId + '" src="' + LogicECM.DocumentCategoryAttachmentsList.generateThumbnailUrl(record) + '" alt="' + extn + '" title="' + $html(name) + '" /></a></span>';
                    } else {
                        elCell.innerHTML = '<span class="thumbnail">' + (isLink ? '<span class="link"></span>' : '') + '<img id="' + imgId + '" src="' + LogicECM.DocumentCategoryAttachmentsList.generateThumbnailUrl(record) + '" alt="' + extn + '" title="' + $html(name) + '" /></span>';
                    }
                };
            },
             ...
             */
            fnRenderCellDescription: function DocumentCategoryAttachmentsList_fnRenderCellDescription() {
                var scope = this;
                ...
                return function (elCell, oRecord, oColumn, oData) {
                    ...
                    if (($isValueSet(properties.lockOwner) || $isValueSet(properties.workingCopyOwner)) && !jsNode.hasAspect("trx:transferred")) {
                        var bannerUser = properties.lockOwner || properties.workingCopyOwner,
                            bannerLink = LogicECM.DocumentCategoryAttachmentsList.generateUserLink(scope, bannerUser);
                    ...
                    /* Title */
                    if (scope.options.showFileFolderLink) {
                        desc += '<h3 class="filename"><span id="' + filenameId + '">' + LogicECM.DocumentCategoryAttachmentsList.generateFileFolderLinkMarkup(scope, record);
             ...
             */
            fnRenderCellActions: function DocumentCategoryAttachmentsList_fnRenderCellActions() {
                var scope = this;
                 ...
                 * @param oData {object|string}
                 */
                return function DocumentCategoryAttachmentsList_renderCellActions(elCell, oRecord, oColumn, oData) {
                    oColumn.width = 200;
                    Dom.setStyle(elCell, "width", oColumn.width + "px");
                    Dom.setStyle(elCell.parentNode, "width", oColumn.width + "px");
            ...
            onActionShowMore: function DocumentCategoryAttachmentsList_onActionShowMore(record, elMore) {
                var me = this;
                ...
                var fnHidePopup = function DocumentCategoryAttachmentsList_oASM_fnHidePopup() {
             ...
             */
            onDocListRefresh: function DocumentCategoryAttachmentsList_onDocListRefresh(layer, args) {
                var obj = args[1];
             ...
             */
            _findRecordByParameter: function DocumentCategoryAttachmentsList__findRecordByParameter(p_value, p_parameter) {
             ...
             */
            onFileRenamed: function DocumentCategoryAttachmentsList_onFileRenamed(layer, args) {
                var obj = args[1];
             ...
             * @param args {array} Event parameters (depends on event type)
             */
            onFileAction: function DocumentCategoryAttachmentsList_onFileAction(layer, args) {
                var obj = args[1];
                if (obj) {
                    if (!obj.multiple) {
                        this._updateDocList.call(this);
             ...
             */
            onDocumentListDragEnter: function DocumentCategoryAttachmentsList_onDocumentListDragEnter(e) {
             ...
             */
            onDocumentListDragOver: function DocumentCategoryAttachmentsList_onDocumentListDragOver(e) {
             ...
             */
            onDocumentListDragLeave: function DocumentCategoryAttachmentsList_onDocumentListDragLeave(e) {
             ...
             */
            onDocumentListDrop: function DocumentCategoryAttachmentsList_onDocumentListDrop(e) {
                try {
