 ...
 * @author snovikov
 */
public class ViewVersionComponentEvaluator extends DefaultSubComponentEvaluator {
	...
	public boolean evaluate(RequestContext context, Map<String, String> params) {
		...
		boolean isReadOnlyCategory = evaluatorsUtil.checkReadOnlyCategory(nodeRef);
		return !hasPermission || isReadOnlyCategory;
	}
}
