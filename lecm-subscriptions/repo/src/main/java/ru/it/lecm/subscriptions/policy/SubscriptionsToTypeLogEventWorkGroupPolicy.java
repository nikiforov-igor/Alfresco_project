 ...
 * Time: 16:30
 */
public class SubscriptionsToTypeLogEventWorkGroupPolicy implements NodeServicePolicies.OnCreateAssociationPolicy, NodeServicePolicies.OnDeleteAssociationPolicy {
	final protected Logger logger = LoggerFactory.getLogger(SubscriptionsToTypeLogEventWorkGroupPolicy.class);
	...
	public final void init() {
		policyComponent.bindAssociationBehaviour(NodeServicePolicies.OnCreateAssociationPolicy.QNAME,
				SubscriptionsService.TYPE_SUBSCRIPTION_TO_TYPE, SubscriptionsService.ASSOC_DESTINATION_WORK_GROUP,
