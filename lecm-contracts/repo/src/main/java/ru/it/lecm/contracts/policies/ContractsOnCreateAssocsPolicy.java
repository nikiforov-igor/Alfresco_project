 ...
 * Time: 17:30
 */
public class ContractsOnCreateAssocsPolicy extends LogicECMAssociationPolicy {
    @Override
    public final void init() {
        super.init();
        policyComponent.bindAssociationBehaviour(NodeServicePolicies.OnDeleteAssociationPolicy.QNAME,
                ContractsBeanImpl.TYPE_CONTRACTS_DOCUMENT, new JavaBehaviour(this, "onDeleteAssociation"));
