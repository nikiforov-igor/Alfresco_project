 ...
 *         &lt;element name="info" type="{http://schemas.datacontract.org/2004/07/UCloud.Gate.Proxy.InvoiceClasses}Torg12SellerTitleInfo" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GenerateTorg12XmlForSeller")
public class GenerateTorg12XmlForSeller {
    ...
    @XmlElement(nillable = true)
    protected Torg12SellerTitleInfo info;
     ...
     * @return
     *     possible object is
     *     {@link Torg12SellerTitleInfo }
     *     
     */
    public Torg12SellerTitleInfo getInfo() {
        return info;
    }
     ...
     *     
     */
    public void setInfo(Torg12SellerTitleInfo value) {
        this.info = value;
    }
