...
"${declOfNum(1, ["поручение","поручения","поручений"])}"
"${declOfNum(2, ["поручение","поручения","поручений"])}"
"${declOfNum(3, ["поручение","поручения","поручений"])}"
"${declOfNum(5, ["поручение","поручения","поручений"])}"
"${declOfNum(10, ["поручение","поручения","поручений"])}"
"${declOfNum(111, ["поручение","поручения","поручений"])}"
"${declOfNum(19, ["поручение","поручения","поручений"])}"
"${declOfNum(21, ["поручение","поручения","поручений"])}"
"${declOfNum(0, ["поручение","поручения","поручений"])}"
