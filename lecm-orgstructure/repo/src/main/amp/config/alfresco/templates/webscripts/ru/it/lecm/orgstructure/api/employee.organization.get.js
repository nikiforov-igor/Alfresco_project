...
if (employee != null) {
    var contractorAssoc = employee.assocs["lecm-orgstr-aspects:linked-contractor-assoc"];
    if (contractorAssoc != null && contractorAssoc.length > 0) {
        var contractor = contractorAssoc[0];
        var organizationAssoc = contractor.sourceAssocs["lecm-orgstr-aspects:linked-contractor-assoc"];
