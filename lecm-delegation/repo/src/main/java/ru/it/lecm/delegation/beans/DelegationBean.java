...
public class DelegationBean extends BaseBean implements IDelegation, IDelegationDescriptor {
    ...
    /**
     * поиск значения проверти или ассоциации в JSON объекте который пришел с
     * формы
     *
    ...
    /**
     * служебный метод делегирования, нарезает или отбирает права с помощью
     * OrgstructureSGNotifierBean
     *
