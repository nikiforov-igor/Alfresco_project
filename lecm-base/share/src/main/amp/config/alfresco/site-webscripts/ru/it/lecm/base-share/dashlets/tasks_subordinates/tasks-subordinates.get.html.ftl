<!-- Workflow Actions -->
<@script type="text/javascript" src="${url.context}/res/components/workflow/workflow-actions.js"></@script>
<!-- Tasks subordinations-->
<@link rel="stylesheet" type="text/css" href="${url.context}/res/css/lecm-base/dashlets/tasks-subordinates.css" />
<@script type="text/javascript" src="${url.context}/res/scripts/lecm-base/dashlets/tasks-subordinates.js"/>
