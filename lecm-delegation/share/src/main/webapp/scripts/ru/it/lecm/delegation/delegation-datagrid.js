 ...
 *
 * @namespace Alfresco
 * @class LogicECM.module.Delegation.DataGrid
 */
(function()
{
   /**
    ...
    * @return {LogicECM.module.Delegation.DataGrid} The new DataGrid instance
    * @constructor
    */
   LogicECM.module.Delegation.DataGrid = function(htmlId)
   {
      LogicECM.module.Delegation.DataGrid.superclass.constructor.call(this, "LogicECM.module.Delegation.DataGrid", htmlId, ["button", "container", "datasource", "datatable", "paginator", "animation", "history"]);
...
//      YAHOO.Bubbling.on("dataItemsDuplicated", this.onDataGridRefresh, this);
    ...
    */
   YAHOO.extend(LogicECM.module.Delegation.DataGrid, Alfresco.component.Base);

   /**
    * Augment prototype with Common Actions module
    */
   YAHOO.lang.augmentProto(LogicECM.module.Delegation.DataGrid, LogicECM.module.Delegation.Actions);

   /**
    * Augment prototype with main class implementation, ensuring overwrite is enabled
    */
   YAHOO.lang.augmentObject(LogicECM.module.Delegation.DataGrid.prototype,
   {
      /**
      ...
      onReady: function DataGrid_onReady()
      {
         ...
         YAHOO.util.Dom.removeClass(this.id + "-selectListMessage", "hidden");
       ...
       * @param p_response {Object} Server response object from Ajax request wrapper
       * @param p_message {Object} Object literal of the format:
       *    <pre>
      ...
      onDatalistColumns: function DataGrid_onDatalistColumns(response)
      {
         ...
         YAHOO.util.Dom.addClass(this.id + "-selectListMessage", "hidden");
      ...
      _setupHistoryManagers: function DataGrid__setupHistoryManagers()
      {
         ...
         if (this.options.usePagination)
         {
            ...
            YAHOO.util.Dom.setStyle(this.id + "-datagridBarBottom", "display", "block");
         }
...
//         this.widgets.dataSource = new YAHOO.util.DataSource(Alfresco.constants.PROXY_URI + "logicecm/generateTestUnit",
      ...
      onItemSelect: function DataGrid_onItemSelect(sType, aArgs, p_obj)
      {
         ...
         YAHOO.util.Event.preventDefault(domEvent);
      },
      ...
      onEventHighlightRow: function DataGrid_onEventHighlightRow(oArgs)
      {
         ...
         var elActions = YAHOO.util.Dom.get(this.id + "-actions-" + oArgs.target.id);
         ...
         if (elActions && elActions.firstChild === null)
         {
            ...
            var record = this.widgets.dataTable.getRecord(oArgs.target.id),
               clone = YAHOO.util.Dom.get(this.id + "-actionSet").cloneNode(true);
            ...
            YAHOO.util.Dom.addClass(clone, "simple");
         ...
         else if (!YAHOO.util.Dom.hasClass(document.body, "masked"))
         {
            this.currentActionsMenu = elActions;
            // Show the actions
            YAHOO.util.Dom.removeClass(elActions, "hidden");
      ...
      onEventUnhighlightRow: function DataGrid_onEventUnhighlightRow(oArgs)
      {
         ...
         if (!this.showingMoreActions || YAHOO.util.Dom.hasClass(document.body, "masked"))
         {
            // Just hide the action links, rather than removing them from the DOM
            YAHOO.util.Dom.addClass(elActions, "hidden");
            this.deferredActionsMenu = null;
         }
      },
...
//            this.datalistMeta = obj.dataList;
      ...
      _setDefaultDataTableErrors: function DataGrid__setDefaultDataTableErrors(dataTable)
      {
         ...
         dataTable.set("MSG_EMPTY", msg("message.empty", "LogicECM.module.Delegation.DataGrid"));
         dataTable.set("MSG_ERROR", msg("message.error", "LogicECM.module.Delegation.DataGrid"));
      },
