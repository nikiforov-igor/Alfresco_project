<@link rel="stylesheet" type="text/css" href="${url.context}/res/components/upload/dnd-upload.css" />
<@script type="text/javascript" src="${url.context}/res/scripts/lecm-base/components/lecm-dnd-upload.js"/>
