...
<@script type="text/javascript" src="${page.url.context}/res/ru/it/lecm/calendar/calendar-view.js"></@script>
<#assign view=context.properties.filteredView />
<#if (view=='agenda')>
   <@script type="text/javascript" src="${page.url.context}/res/ru/it/lecm/calendar/calendar-view-${context.properties.filteredView?js_string}.js"></@script>
<#else>
   ...
   <@script type="text/javascript" src="${page.url.context}/res/ru/it/lecm/calendar/calendar-view-fullCalendar.js"></@script>
</#if>
<@script type="text/javascript" src="${page.url.context}/res/ru/it/lecm/calendar/eventinfo.js"></@script>
<!-- Tag library -->
