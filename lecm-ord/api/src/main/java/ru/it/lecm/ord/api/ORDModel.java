...
public final class ORDModel {
	...
	public static enum P_STATUSES {
		WAIT_PERFORMANCE_STATUS, PERFORMANCE_STATUS, EXECUTED_STATUS, NOT_EXECUTED_STATUS, EXPIRED_STATUS, CANCELED_STATUS, EXECUTED_BY_CONTROLLER_STATUS, CANCELED_BY_CONTROLLER_STATUS};
	public static final EnumMap POINT_STATUSES = new EnumMap<P_STATUSES,String>(P_STATUSES.class){{
