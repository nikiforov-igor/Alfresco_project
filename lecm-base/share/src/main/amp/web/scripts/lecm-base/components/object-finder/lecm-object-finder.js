...
(function()
{
    ...
    * @constructor
    */
   LogicECM.module.ObjectFinder = function Alfresco_ObjectFinder(htmlId, currentValueHtmlId)
   {
       LogicECM.module.ObjectFinder.superclass.constructor.call(this, "LogicECM.module.ObjectFinder", htmlId, ["button", "menu", "container", "resize", "datasource", "datatable"]);
   ...
   YAHOO.extend(LogicECM.module.ObjectFinder, Alfresco.component.Base,
   {
      ...
      {
         LogicECM.module.ObjectFinder.superclass.setMessages.call(this, obj);
                  ...
                  if (items.hasOwnProperty(key))
                  {
                     ...
                     else
                     {
                        if (this.options.displayMode == "items")
                        {
                           if (item.type === "tag")
                           {
	                          displayValue += Util.getCroppedItem(this.options.objectRenderer.renderItem(item, null, "<div class='itemtype-tag'>{name}</div>"));
                           }
                           else
                           {
...
(function()
{
    ...
    * @constructor
    */
   LogicECM.module.ObjectRenderer = function(objectFinder)
   {
      this.objectFinder = objectFinder;

       LogicECM.module.ObjectRenderer.superclass.constructor.call(this, "LogicECM.module.ObjectRenderer", objectFinder.pickerId, ["button", "menu", "container", "datasource", "datatable"]);
      /**
       * Decoupled event listeners
       */
