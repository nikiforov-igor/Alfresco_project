(function() {
	...
	var endStr = request.end;
	var end = DateFromISO8601(endStr);

	var workingDaysNumber = workCalendar.getEmployeeWorkingDaysNumber(nodeRefStr, start, end);
	model.workingDaysNumber = workingDaysNumber;
}());
