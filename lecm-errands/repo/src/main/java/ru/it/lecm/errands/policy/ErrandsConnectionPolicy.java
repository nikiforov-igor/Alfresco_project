...
public class ErrandsConnectionPolicy extends BaseBean implements NodeServicePolicies.OnCreateAssociationPolicy {
    ...
    public void onCreateAssociation(AssociationRef associationRef) {
        ...
        //инкремент счетчика индекса поручения
        nodeService.setProperty(errandDoc,ErrandsService.PROP_ERRANDS_CHILD_INDEX, (Integer) nodeService.getProperty(errandDoc,ErrandsService.PROP_ERRANDS_CHILD_INDEX) + 1);
