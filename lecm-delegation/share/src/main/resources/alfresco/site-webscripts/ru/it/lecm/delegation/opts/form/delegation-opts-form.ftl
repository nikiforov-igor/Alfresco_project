...
<@formLib.renderFormContainer formId=formId>
	...
	<fieldset
            ...
            form="${formId}"
            style="border: 0; margin-bottom: 0; padding: 0px 0px 0px 1px;"
...
//							},
	...
	<#--</div>-->
	<fieldset id="fieldset-delegate-all-func" form="${formId}" style="border: 0; margin-bottom: 0; padding: 0px 0px 0px 1px;">
